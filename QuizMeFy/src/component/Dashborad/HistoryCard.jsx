...
export default function HistoryCard({ item }) {
  return (
    <div className="bg-slate-800/30 hover:bg-slate-800 duration-300 cursor-pointer hover:scale-x-105 hover:border hover:border-sky-500 my-4 p-3 flex rounded-lg">
